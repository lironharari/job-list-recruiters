...
const templates = [
  ...
  },
  {
    ...
    subject: 'You have been accepted for {{jobTitle}}',
    body: '<p>Congratulations {{name}},<br>Your application for the {{jobTitle}} position has been accepted! We look forward to working with you.</p>',
  },
];
